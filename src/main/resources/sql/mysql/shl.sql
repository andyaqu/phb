...
MySQL - 5.0.18-nt : Database - deepthroat
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`deepthroat` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `deepthroat`;

/*Table structure for table `shl_article` */

DROP TABLE IF EXISTS `shl_article`;

CREATE TABLE `shl_article` (
...
/*Data for the table `shl_calllist` */

insert  into `shl_calllist`(`id`,`channelId`,`callId`) values (2,11,'17,18'),(1,2,'9,8');

/*Table structure for table `shl_comment` */

DROP TABLE IF EXISTS `shl_comment`;

CREATE TABLE `shl_comment` (
  `id` int(11) NOT NULL auto_increment,
...
/*Data for the table `shl_comment` */

/*Table structure for table `shl_download` */

DROP TABLE IF EXISTS `shl_download`;

CREATE TABLE `shl_download` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_download` */

/*Table structure for table `shl_flash` */

DROP TABLE IF EXISTS `shl_flash`;

CREATE TABLE `shl_flash` (
  `id` int(11) NOT NULL auto_increment,
  `title` text,
...
/*Data for the table `shl_flash` */

insert  into `shl_flash`(`id`,`title`,`url`,`picpath`,`group_id`,`ordering`,`summary`,`dt_time`) values (1,'世界热气球比赛','http://www.deepthroat.com.cn','/upload/200710/20071027095455797.jpg',1,1,'世界热气球比赛','2008-01-22 02:01:34'),(2,'多色多彩的热气球','http://www.deepthroat.com.cn','/upload/200710/200710270955095.jpg',1,2,'多色多彩的热气球','2007-10-27 09:55:09'),(3,'四只热气球','http://www.deepthroat.com.cn','/upload/200710/20071027095519831.jpg',1,3,'四只热气球','2007-10-27 09:55:19'),(4,'满天热气球','http://www.deepthroat.com.cn','/upload/200710/20071027095529300.jpg',1,4,'满天热气球','2007-10-27 09:55:29'),(5,'家具1','','/upload/200801/20080121234326963.jpg',2,0,'','2008-01-23 12:02:12'),(6,'家具2','','/upload/200801/20080121234335164.jpg',2,0,'','2008-01-23 12:02:17');

/*Table structure for table `shl_flash_group` */

DROP TABLE IF EXISTS `shl_flash_group`;

CREATE TABLE `shl_flash_group` (
  `id` int(11) NOT NULL auto_increment,
...
/*Data for the table `shl_flash_group` */

insert  into `shl_flash_group`(`id`,`title`,`summary`,`dt_time`,`sign`) values (1,'【首页】flash图片展示','这个flash可以展示变换的图片。','2008-01-23 12:06:21',1),(2,'【首页】家具轮换图片','轮换图片','2008-01-23 12:06:21',0);

/*Table structure for table `shl_guestbook` */

DROP TABLE IF EXISTS `shl_guestbook`;

CREATE TABLE `shl_guestbook` (
  `id` int(11) NOT NULL auto_increment,
...
/*Data for the table `shl_guestbook` */

/*Table structure for table `shl_jobs` */

DROP TABLE IF EXISTS `shl_jobs`;

CREATE TABLE `shl_jobs` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_jobs` */

insert  into `shl_jobs`(`id`,`channelId`,`jobName`,`jobKind`,`requireNum`,`experience`,`address`,`age`,`height`,`languageSkill`,`lastTime`,`salary`,`educational`,`isHouse`,`sex`,`computerLevel`,`summary`,`telphone`,`email`,`dtTime`,`ordering`,`sign`,`classification`) values (3,13,'Manager','Full-time ',4,'3 years','Beijing','25 years old and above ','Open','English','2010-04-25','2000¥','大专','No','男','--不限--','<p>1, college education<br />\r\n<br />\r\n2, in the TV repair work for more than three years, and have some management experience.<br />\r\n<br />\r\n3, can be hard-working, communication ability, and good image.<br />\r\n<br />\r\n4, around the age of 30 years old.</p>','021-68683265','jobs@163.com','2008-03-19 17:46:48',0,0,'en'),(4,13,'Recruitment Outsourc','Full-time ',12,'more than five years','Beijing','35 years old ','opne','English','2010-05-25','¥3000','大专','No','男','--不限--','<p>1, college education <br />\r\n<br />\r\n2, and is familiar with the &quot;CIS&quot; market, and understand Russian with strong oral communication skills. <br />\r\n<br />\r\n3, in the TV marketing efforts for more than three years, and have some management experience. <br />\r\n<br />\r\n4, can be hard-working, communication ability, and good character. <br />\r\n<br />\r\n5, under the age of 35.</p>','021-23659535','jobs@163.com ','2008-03-19 17:51:04',0,0,'en'),(1,4,'售后经理','全职',2,'3年以上','北京','25岁以上','不限','英语','2010-04-25','2000+提成','大专','不提供住房','男','--不限--','<p>1、 大专以上学历</p>\r\n<p>2、 从事彩电维修工作三年以上，并具有一定的管理经验。</p>\r\n<p>3、 能吃苦耐劳，沟通能力强，形象良好。</p>\r\n<p>4、 年龄在30岁左右。</p>','021-68683265','jobs@163.com','2008-03-19 15:04:22',0,0,'cn'),(2,4,'国外客户经理','全职',6,'5年以上','北京','35岁以下','不限','俄语','2010-04-29','3000+提成','大专','不提供','男','--不限--','<p>1、大专以上学历</p>\r\n<p>2、熟悉&ldquo;独联体&rdquo;市场，懂俄文并具有较强口语沟通能力。</p>\r\n<p>3、从事彩电营销工作三年以上，并具有一定的管理经验。</p>\r\n<p>4、能吃苦耐劳，沟通能力强，品行良好。</p>\r\n<p>5、年龄在35岁以下。</p>','021-23659535','jobs@163.com','2008-03-19 15:07:36',0,0,'cn');

/*Table structure for table `shl_linkers` */

DROP TABLE IF EXISTS `shl_linkers`;

CREATE TABLE `shl_linkers` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_linkers` */

insert  into `shl_linkers`(`id`,`channelId`,`links`,`linkerName`,`linkAddress`,`origialPic`,`smallPic`,`summary`,`dtTime`,`ordering`) values (1,24,0,'skype中国代理','http://service-skype.com.cn/','/upload/200902/20090207160858302.gif','/upload/200902/s_20090207160858302.gif','<p>skype中国代理</p>','2008-12-30 02:30:12',0),(2,24,0,'七彩发光字','http://www.qcfgz.com/','/upload/200902/20090207160916154.gif','/upload/200902/s_20090207160916154.gif','<p>七彩发光字</p>','2008-12-30 02:31:06',0),(3,24,0,'祥平房产','http://www.xpfc.com.cn/','/upload/200902/20090207161716993.gif','/upload/200902/s_20090207161716993.gif','<p>祥平房产</p>','2008-12-30 02:32:01',0),(4,24,0,'鼎晟科技','http://www.dingshengcn.com/','/upload/200902/20090207160928294.gif','/upload/200902/s_20090207160928294.gif','<p>鼎晟科技</p>','2008-12-30 02:32:55',0),(5,24,0,'和君咨询','http://eng.hjcn.com.cn/','/upload/200902/20090207161806166.gif','/upload/200902/s_20090207161806166.gif','<p>和君咨询</p>','2008-12-30 02:33:28',0),(6,24,0,'深喉咙企业官方网站','http://www.deepthroat.com.cn/','/upload/200902/20090207161820634.jpg','/upload/200902/s_20090207161820634.jpg','<p>深喉咙企业官方网站</p>','2008-12-30 02:36:17',0),(7,24,1,'杭州恒翔纺织','http://www.hx-textiles.cn/','','','<p>杭州恒翔纺织</p>','2008-12-30 02:37:12',0),(8,24,1,'福建新大陆','http://www.nlscan.com/','','','<p>福建新大陆</p>','2008-12-30 02:38:01',0),(9,24,1,'中山市祥鸿游艺机械厂','http://www.amuserides.com/','','','<p>中山市祥鸿游艺机械厂</p>','2008-12-30 02:38:29',0),(10,24,1,'佛山市骏朗会计师事务所','http://www.jlcpa.com.cn/','','','<pre id=\"line1\">\r\n佛山市骏朗会计师事务所</pre>','2008-12-30 02:39:08',0),(11,24,1,'郑州大仟伯商贸有限公司','http://deepthroat-site.kb8.cn/','','','郑州大仟伯商贸有限公司','2008-12-30 02:40:07',0),(12,24,1,'广厦集团','http://gsjt.hebishi.com/','','','<p>广厦集团</p>','2008-12-30 02:41:08',0),(13,24,1,'海达之光','http://www.65388488.com/','','','<p>海达之光</p>','2008-12-30 02:43:01',0),(14,24,0,'河南三网互联科技有限公司','http://www.3netlink.com','/upload/200902/20090207162507398.gif','/upload/200902/s_20090207162507398.gif',NULL,'2009-02-07 16:25:07',0),(15,24,0,'汽车服务网','http://www.as618.com','/upload/200902/20090207162633797.gif','/upload/200902/s_20090207162633797.gif',NULL,'2009-02-07 16:26:33',0),(16,24,0,'武汉楚剑','http://www.cjkj110.com','/upload/200902/20090207162950715.gif','/upload/200902/s_20090207162950715.gif',NULL,'2009-02-07 16:29:50',0),(17,24,0,'达诚通信','http://www.rdcom.com','/upload/200902/20090207163111923.jpg','/upload/200902/s_20090207163111923.jpg',NULL,'2009-02-07 16:31:11',0),(18,25,1,'wordpress','http://www.wordpress.org','','',NULL,'2009-02-07 16:42:40',0);

/*Table structure for table `shl_list` */

DROP TABLE IF EXISTS `shl_list`;

CREATE TABLE `shl_list` (
  `id` int(11) NOT NULL auto_increment,
...
/*Data for the table `shl_list` */

insert  into `shl_list`(`id`,`isTopic`,`isImportant`,`channelId`,`title`,`author`,`source`,`counts`,`dtTime`,`editTime`,`tags`,`check`,`uname`,`summary`,`pic`,`recommend`,`mark`,`guid`,`isPic`,`spic`,`cguid`,`origialPic`,`smallPic`,`ordering`,`sign`) values (20,0,0,18,'Newland Exhibits in CeBIT 2008','newland','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','Newland Exhibits in CeBIT 2008',0,'','','',0,0,'E8661FBB6AC796D6',0,'','','','',0,0),(19,0,0,18,'Newland\'s website was renewed','newland','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','Newland\'s website was renewed',0,'','','',0,0,'66619B933DD62E75',0,'','','','',0,0),(18,0,0,18,'Archuleta\'s Daddy Dearest?','yahoo','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','Archuleta\'s Daddy Dearest?',0,'','','',0,0,'D879E27679191A82',0,'','','','',0,0),(17,0,0,18,'Archuleta\'s Daddy Dearest?','yahoo','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','Archuleta\'s Daddy Dearest?',0,'','','',0,0,'42BAF092D9DC5F1A',0,'','','','',0,0),(16,0,0,18,'94-74 win over Houston','yahoo','',1,'2008-03-19 00:00:00','2008-03-19 00:00:00','Garnett, Pierce lead Celtics to 94-74 win over Houston, snap',0,'','','',0,0,'8CA87CDF9412B457',0,'','','','',0,0),(15,0,0,17,' China warns of \'life or death struggle\' in Tibet ','yahoo','',12,'2008-03-19 00:00:00','0000-00-00 00:00:00',' China warns of \'life or death struggle\' in Tibet ',0,'','','',0,0,'095F673E6077D528',0,'','','','',0,0),(14,0,0,17,'UK papers apologize to McCann parents ','yahoo','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','UK papers apologize to McCann parents ',0,'','','',0,0,'F945F5A48A8DAED7',0,'','','','',0,0),(13,0,0,17,' 4 killed in SoCal workplace shooting','yahoo','',5,'2008-03-19 00:00:00','0000-00-00 00:00:00',' 4 killed in SoCal workplace shooting',0,'','','',0,0,'177E1FA6485E7CD0',0,'','','','',0,0),(12,0,0,17,'Jury awards $590 million in Reno killing ','yahoo','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','Jury awards $590 million in Reno killing ',0,'','','',0,0,'CC30A79C30184650',0,'','','','',0,0),(11,0,0,17,'Spitzer call girl loses $1 mln offer over videos ','Deepthroat','',0,'2008-03-19 00:00:00','0000-00-00 00:00:00','girl',0,'','','',0,0,'AEFA72DF8C593E49',0,'','','','',0,0),(10,0,0,9,'技术解决方案','Deepthroat','',1,'2008-03-19 00:00:00','0000-00-00 00:00:00','技术解决方案',0,'','','',0,0,'3543F7FA8B628CD8',0,'','','','',0,0),(9,0,0,9,'咨询/服务行业网站解决方案','Deepthroat','',2,'2008-03-19 00:00:00','0000-00-00 00:00:00','咨询/服务行业网站解决方案',0,'','','',0,0,'10B66AF3096B49A5',0,'','','','',0,0),(8,0,0,9,'国际贸易网站解决方案','realure','',1,'2008-03-19 00:00:00','0000-00-00 00:00:00','国际贸易网站解决方案',0,'','','',0,0,'661A8F51D3734918',0,'','','','',0,0),(7,0,0,9,'IT公司网站解决方案','Deepthroat','',2,'2008-03-19 00:00:00','0000-00-00 00:00:00','IT公司网站解决方案',0,'','','',0,0,'831465C8B8F5AD4D',0,'','','','',0,0),(5,0,0,8,'合作伙伴计划','Deepthroat','',5,'2008-03-19 00:00:00','0000-00-00 00:00:00','合作伙伴',0,'','','',0,0,'7AE4AC4C439A2987',0,'','','','',0,0),(6,0,0,9,'解决方案','Deepthroat','',3,'2008-03-19 00:00:00','0000-00-00 00:00:00','解决方案',0,'','','',0,0,'2EBC4240C0D14162',0,'','','','',0,0),(4,0,0,8,'深喉咙法律声明','Deepthroat','',2,'2008-03-19 00:00:00','0000-00-00 00:00:00','法律',0,'','','',0,0,'A509981A1781866A',0,'','','','',0,0),(3,0,0,8,'深喉咙专用主机热卖中','Deepthroat','',1,'2008-03-19 00:00:00','0000-00-00 00:00:00','主机',0,'','','',0,0,'5158BDDB23928BFF',0,'','','','',0,0),(1,0,0,8,'“深喉咙”来由','Deepthroat','',2,'2008-03-19 00:00:00','0000-00-00 00:00:00','来由',0,'','','',0,0,'458EF974A4FD23C6',0,'','','','',0,0),(2,0,0,8,'Deepthroat 简要招商计划','Deepthroat','',2,'2008-03-19 00:00:00','0000-00-00 00:00:00','招商',0,'','','',0,0,'54466B69A9EA75B8',0,'','','','',0,0);

/*Table structure for table `shl_list_content` */

DROP TABLE IF EXISTS `shl_list_content`;

CREATE TABLE `shl_list_content` (
  `guid` varchar(16) NOT NULL default '',
  `pageId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_menu` */

insert  into `shl_menu`(`id`,`menuName`,`title`,`summary`,`keys`,`type`,`ordering`,`link`,`deep`,`parentId`,`params`,`published`,`isClaw`,`template`,`isfun`,`isComment`,`level`,`isHidden`,`origialPic`,`smallPic`,`width`,`hight`,`isExternalLinks`,`dtLanguage`,`redirectUrl`,`related_common`) values (16,'EnterprisesHonor','EnterprisesHonor','Enterprises Honor','','article',0,'',1,10,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(15,'CorporateCulture','Corporate Culture','Corporate Culture','','article',0,'',1,10,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(14,'ContactUs','Contact Us','Contact Us','','article',0,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(13,'Recruitmenting','Recruitment','Recruitment','','jobs',0,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(12,'ProductsCenter','Products','Products','','product',0,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(11,'eNews','News','NewsCenter','','calllist',0,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(10,'CompanyProfile','Company Profile','Company Profile','','article',0,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(9,'industry','行业咨询','行业咨询','','list',0,'',1,2,'',0,0,'',0,0,0,0,'/upload/200811/20081122102102364.jpg','/upload/200811/s_20081122102102364.jpg',130,130,0,'cn','','common.php'),(8,'hotNews','热点新闻','热点新闻','','list',0,'',1,2,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(7,'honours','企业荣誉','企业荣誉','','article',0,'',1,1,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(6,'culture','企业文化','企业文化','','article',0,'',1,1,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(5,'contact','联系我们','联系我们','','article',5,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(4,'recruitment','人才招聘','人才招聘','','jobs',0,'',0,0,'',0,0,'',0,0,0,1,'','',130,130,0,'cn','','common.php'),(3,'product','产品展示','产品中心','','product',3,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(1,'company','关于我们','关于我们','','article',2,'',0,0,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(2,'news','新闻中心','新闻中心','','calllist',0,'',0,0,'',0,0,'',0,0,0,1,'/upload/200811/20081122102023799.jpg','/upload/200811/s_20081122102023799.jpg',130,130,0,'cn','','common.php'),(17,'HotofNews','Hot News','Hot News','','list',0,'',1,11,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(18,'IndustryAdvisory','Industry Advisory','Industry Advisory','','list',0,'',1,11,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(19,'guestbook','在线留言','在线留言','','guestbook',0,'',1,5,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(20,'messages','guestbook','','','guestbook',0,'',1,14,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(21,'contact','联系我们','联系我们','','article',0,'',1,5,'',0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php'),(22,'eorders','Ordering','orderings','','order',0,'',1,14,'',0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(24,'friendlinks','友情链接','','','linkers',0,'',0,0,NULL,0,0,'',0,0,0,1,'','',130,130,0,'cn','','common_2.php'),(25,'friendlink','friendlink','','','linkers',0,'',0,0,NULL,0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(26,'toupiao','投票','','','poll',0,'',0,0,NULL,0,0,'',0,0,0,1,'','',130,130,0,'cn','','common.php'),(27,'poll','poll','','','poll',0,'',0,0,NULL,0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(29,'vedio','vedio','','','video',0,'',0,0,NULL,0,0,'',0,0,0,0,'','',130,130,0,'en','','common.php'),(28,'vedio','視頻','','','video',0,'',0,0,NULL,0,0,'',0,0,0,1,'','',130,130,0,'cn','','common_2.php'),(30,'online','客户留言','客户留言','','guestbook',4,'',0,0,NULL,0,0,'',0,0,0,0,'','',130,130,0,'cn','','common.php');

/*Table structure for table `shl_models_reg` */

DROP TABLE IF EXISTS `shl_models_reg`;

CREATE TABLE `shl_models_reg` (
  `id` int(11) NOT NULL auto_increment,
...
/*Data for the table `shl_order` */

/*Table structure for table `shl_picture` */

DROP TABLE IF EXISTS `shl_picture`;

CREATE TABLE `shl_picture` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
  `title` varchar(60) NOT NULL default '',
...
/*Data for the table `shl_picture` */

/*Table structure for table `shl_poll` */

DROP TABLE IF EXISTS `shl_poll`;

CREATE TABLE `shl_poll` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
  `choice` varchar(255) NOT NULL,
  `categoryId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_poll` */

insert  into `shl_poll`(`id`,`channelId`,`choice`,`categoryId`,`isdefault`,`ordering`,`num`) values (1,13,'增加网站模板',1,'b',0,20),(2,13,'整体功能',1,'a',0,16),(3,13,'增加采集功能',1,'b',0,10),(4,13,'搜索引擎优化',1,'b',0,12),(6,13,'采集功能',2,'a',0,16),(7,13,'会员功能',2,'b',0,15),(8,13,'商城功能',2,'b',0,20),(9,13,'对话功能',2,'b',0,12),(10,26,'一般',3,'b',0,1),(11,26,'不错',3,'b',1,1),(12,26,'有所改进',3,'a',0,2),(13,27,'General',4,'b',0,1),(14,27,'Improve',4,'b',0,1),(15,27,'good',4,'a',0,1);

/*Table structure for table `shl_poll_category` */

DROP TABLE IF EXISTS `shl_poll_category`;

CREATE TABLE `shl_poll_category` (
  `id` int(11) NOT NULL auto_increment,
  `title` varchar(200) NOT NULL default '',
  `choice` set('a','b') default 'a',
  `client_ip` longtext,
...
/*Data for the table `shl_poll_category` */

insert  into `shl_poll_category`(`id`,`title`,`choice`,`client_ip`,`channelId`,`dtTime`,`ordering`) values (1,'您觉得深喉咙哪些地方还需改进？','b','2130706433',13,'2008-12-29',0),(2,'您期待增加哪些功能？','a','2130706433',13,'2008-12-29',0),(3,'3.8双语版测试建议','a','2130706433',26,'2009-02-07',0),(4,'suggest','a',NULL,27,'2009-02-07',0);

/*Table structure for table `shl_product` */

DROP TABLE IF EXISTS `shl_product`;

CREATE TABLE `shl_product` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_product` */

insert  into `shl_product`(`id`,`channelId`,`name`,`sn`,`spec`,`dtTime`,`sellingPrice`,`preferPrice`,`summary`,`content`,`origialPic`,`middlePic`,`smallPic`,`indexPicture`,`categoryId`,`counts`,`ordering`,`sign`) values (5,3,'多普达S1','多普达S1','智能手机','2008-03-19 14:54:12','3500.00','3199.00','白色版的多普达S1由于其钢琴烤漆的机身，给人感觉高档中不失活泼时尚。十分适合现在的年轻人使用。','<p><font id=\"Zoom\">多普达S1内部拥有一颗主频为201MHz的TI OMAP 850处理器。运行频率201MHz，64MB DDR RAM，128MB ROM的内存配备，用户还可通过MicroSD卡扩展。S1采用的TouchFLO技术是此款产品最大的亮点，TouchFLO技术的特点是用手指替代了 手写笔，用户只需用手指在屏幕上轻轻滑动便可完成各种操作，同样TouchFLO技术也支持手写笔功能，机器本身能自动区分手写笔与手指。</font></p>','/upload/200803/2008031914541210.jpg','/upload/200803/m_2008031914541210.jpg','/upload/200803/s_2008031914541210.jpg','/upload/200803/i_2008031914541210.jpg',2,25,0,0),(6,3,'草莓BB8700g','BB8700g','智能手机','2008-03-19 14:58:38','3600.00','3200.00','莓手机的配置也一向是注意键盘操盘与屏幕显示。这款8700g也是一样，配备了横屏QVGA的屏幕以及QWERT的键盘。同样，定位于商务应用的这款黑莓也一如既往的没有配备摄像头以及存储卡插槽。','<p>整个8700g的设计就像一把盾牌，连空格键都是这样。键盘上没有像多普达或诺基亚的横屏机器的摇杆键，这也可以说是黑莓8700g的一大特色。在用惯了 摇杆导航键的其他手机后，你一定会对没有这个设计的黑莓感觉大不适应。但绝对值得一提的是，黑莓的操作系统可以让她的键盘得到最大的功能发挥，你可以在很 多地方（比如信息，电话，主界面等等）使用很多的快捷键，从而更方便快捷的使用这款手机。毫不夸张地说，这款手机的快捷键设计的非常合理与便捷。</p>','/upload/200803/20080319145838251.jpg','/upload/200803/m_20080319145838251.jpg','/upload/200803/s_20080319145838251.jpg','/upload/200803/i_20080319145838251.jpg',2,40,7,0),(4,3,'康佳KJ-25','KJ-25','KJ-25','2008-03-19 14:43:12','12000.00','9999.00','图像效果比较规矩，对比度还是很不错的，色彩艳丽而不夸张','<p>这款46英寸液晶采用三星屏，泰鼎芯片，和索尼BRAVIA ENGINE同样的技术。图像效果比较规矩，对比度还是很不错的，色彩艳丽而不夸张，具有HDMI接口和VGA接口，但是网友反应音质较差，音响噪音过大。最低可达9999元。</p>','/upload/200803/20080319144251460.jpg','/upload/200803/m_20080319144251460.jpg','/upload/200803/s_20080319144251460.jpg','/upload/200803/i_20080319144251460.jpg',1,28,4,0),(3,3,'飞利浦','HJK80','GYU-25','2008-03-19 14:41:48','15000.00','12600.00','采用LPL的S-IPS面板，色彩艳丽，图像清晰锐利，图像通透性高，暗部细节丰富，高亮部分有较好的表现','<p>属于飞利浦高端产品，采用LPL屏，具有100Hz技术和流光溢彩2代效果，装饰效果好，流光溢彩采用的是LED灯管。图像对比度、通透性都非常出色，色彩表现极佳，毫无夸张</p>','/upload/200803/20080319144148185.jpg','/upload/200803/m_20080319144148185.jpg','/upload/200803/s_20080319144148185.jpg','/upload/200803/i_20080319144148185.jpg',1,38,5,0),(2,3,'飞利浦N25','DHJ-25','HIPLK','2008-03-19 14:40:31','9800.00','8500.00','色彩艳丽，图像清晰锐利，图像通透性高，暗部细节丰富，高亮部分有较好的表现，图像的质感真实','<p>这是夏新的一款40英寸液晶电视，采用LPL的S-IPS面板，色彩艳丽，图像清晰锐利，图像通透性高，暗部细节丰富，高亮部分有较好的表现，图像的质感真实。具有2组HDMI，1组VGA接口。</p>','/upload/200803/20080319144031478.jpg','/upload/200803/m_20080319144031478.jpg','/upload/200803/s_20080319144031478.jpg','/upload/200803/i_20080319144031478.jpg',1,24,2,0),(1,3,'夏新','ST-88HT','MHJK','2008-03-19 14:39:25','12000.00','10500.00','色彩艳丽，图像清晰锐利，图像通透性高，暗部细节丰富，高亮部分有较好的表现，图像的质感真实。','<p>这是夏新的一款40英寸液晶电视，采用LPL的S-IPS面板，色彩艳丽，图像清晰锐利，图像通透性高，暗部细节丰富，高亮部分有较好的表现，图像的质感真实。具有2组HDMI，1组VGA接口。</p>','/upload/200803/20080319143925848.jpg','/upload/200803/m_20080319143925848.jpg','/upload/200803/s_20080319143925848.jpg','/upload/200803/i_20080319143925848.jpg',1,24,0,0),(7,12,'Amoi','ST-88HT','MHJK','2008-03-19 17:30:59','12000.00','10500.00','Colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance, image texture true.','<div dir=\"ltr\" id=\"result_box\">This is the Amoi a 40-inch LCD TV, using LPL S-IPS panel, colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance, image texture true. HDMI with Group 2, Group 1 VGA interface.</div>','/upload/200803/20080319173059209.jpg','/upload/200803/m_20080319173059209.jpg','/upload/200803/s_20080319173059209.jpg','/upload/200803/i_20080319173059209.jpg',3,23,0,0),(8,12,'Philips N25','DHJ-25','HIPLK','2008-03-19 17:32:57','9800.00','8500.00','Colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance, image texture true','<div dir=\"ltr\" id=\"result_box\">This is the Amoi a 40-inch LCD TV, using LPL S-IPS panel, colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance, image texture true. HDMI with Group 2, Group 1 VGA interface.</div>','/upload/200803/20080319173257867.jpg','/upload/200803/m_20080319173257867.jpg','/upload/200803/s_20080319173257867.jpg','/upload/200803/i_20080319173257867.jpg',3,23,0,0),(9,12,'Philips','HJK80','GYU-25','2008-03-19 17:35:06','15000.00','12600.00','Using LPL S-IPS panel, colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance.','<div dir=\"ltr\" id=\"result_box\">This is the Amoi a 40-inch LCD TV, using LPL S-IPS panel, colourful, clear sharp images, image permeability, dark rich details, highlighting some of the better performance, image texture true. HDMI with Group 2, Group 1 VGA interface.</div>','/upload/200803/20080319173506675.jpg','/upload/200803/m_20080319173506675.jpg','/upload/200803/s_20080319173506675.jpg','/upload/200803/i_20080319173506675.jpg',3,27,0,0),(10,12,'Konka KJ-25','Konka KJ-25','KJ-25','2008-03-19 17:36:50','12000.00','9999.00','Image Comparison rules, the contrast is very good, without exaggeration colourful','<div dir=\"ltr\" id=\"result_box\">The Samsung 46-inch LCD screen, and Thai tripod chips, and Sony BRAVIA ENGINE same technology. Image Comparison rules, the contrast is very good, colourful without exaggeration, HDMI interface and a VGA interface, but users respond poor sound quality, sound too much noise. As low as 9,999 yuan.</div>','/upload/200803/20080319173650420.jpg','/upload/200803/m_20080319173650420.jpg','/upload/200803/s_20080319173650420.jpg','/upload/200803/i_20080319173650420.jpg',3,26,0,0),(11,12,'Dopod S1','Dopod S1','smart phones ','2008-03-19 17:38:04','3500.00','3199.00','white version of the piano because of its Dopod S1 paint the fuselage, that feeling of luxury without losing in lively fashion. Very suitable for the young people now use.','<p>Dopod S1 has an internal frequency of 201 MHz TI OMAP 850 processor. Operating frequency of 201 MHz, 64MB DDR RAM, 128MB ROM equipped with memory, and users will be able to extend MicroSD card. S1 TouchFLO used new product technology is the biggest bright spot, TouchFLO technology is characterized by a finger replaces the pen, users only need a finger sliding gently on the screen can be completed in various operations, the same TouchFLO technology also supports pen functionality , the machine itself can automatically distinguish between pen and fingers.</p>','/upload/200803/20080319173804114.jpg','/upload/200803/m_20080319173804114.jpg','/upload/200803/s_20080319173804114.jpg','/upload/200803/i_20080319173804114.jpg',4,24,0,0),(12,12,'Strawberry BB8700g ','BB8700g ','smart phones ','2008-03-19 17:39:26','3600.00','3200.00','Description: raspberries phone configuration has always paid attention to the keyboard Global DRAM Pricing and screen display. The 8700 g is the same, with a horizontal screen QVGA screen and QWERT ke','<p>87 g of the whole design as a shield, and even the space bar is so. Dopod on the keyboard like Nokia or horizontal screen machines rocker button, it can be said that this is the BlackBerry 8700 g one of the major features. In the rocker with a joystick used to the other phone, you will certainly not feel the design of the BlackBerry不适应. But definitely worth mentioning is that the BlackBerry operating system will allow her to maximize the functional keyboard play, you can in many places (such as information, telephone, the main interface, etc.) use a lot of shortcut to quicker and more convenient the use of the phone. It is no exaggeration to say that the phone was designed Shortcuts very reasonable and convenient.</p>','/upload/200803/20080319173926949.jpg','/upload/200803/m_20080319173926949.jpg','/upload/200803/s_20080319173926949.jpg','/upload/200803/i_20080319173926949.jpg',4,26,0,0);

/*Table structure for table `shl_product_category` */

DROP TABLE IF EXISTS `shl_product_category`;

CREATE TABLE `shl_product_category` (
  `id` int(11) NOT NULL auto_increment,
  `menuName` varchar(24) NOT NULL default '',
  `title` varchar(50) NOT NULL default '',
  `summary` varchar(200) NOT NULL default '',
...
/*Data for the table `shl_product_category` */

insert  into `shl_product_category`(`id`,`menuName`,`title`,`summary`,`keys`,`type`,`ordering`,`link`,`deep`,`channelId`,`params`,`published`,`isClaw`,`template`,`isfun`,`isComment`,`cguid`,`parentId`) values (2,'','再生资源','再生资源','','',0,'',0,3,'',0,0,'',0,0,'',0),(1,'','成套设备','成套设备','','',0,'',0,3,'',0,0,'',0,0,'',0),(3,'','Flat-screen TVs','Flat-screen TVs','','',0,'',0,12,'',0,0,'',0,0,'',0),(4,'','Smartphone','Smartphone','','',0,'',0,12,'',0,0,'',0,0,'',0),(7,'','钢材贸易','钢材贸易','','',0,'',0,3,NULL,0,0,'',0,0,'',0),(8,'','综合贸易','综合贸易','','',0,'',0,3,NULL,0,0,'',0,0,'',0),(9,'','钛白粉','钛白粉','','',0,'',1,3,NULL,0,0,'',0,0,'',8),(10,'','木塑复合板','木塑复合板','','',0,'',1,3,NULL,0,0,'',0,0,'',8),(11,'','燃料油','木塑复合板','','',0,'',1,3,NULL,0,0,'',0,0,'',8);

/*Table structure for table `shl_resume` */

DROP TABLE IF EXISTS `shl_resume`;

CREATE TABLE `shl_resume` (
  `id` int(11) NOT NULL auto_increment,
  `parentId` int(11) NOT NULL default '0',
  `channelId` int(11) NOT NULL default '0',
...
/*Data for the table `shl_resume` */

/*Table structure for table `shl_solutions` */

DROP TABLE IF EXISTS `shl_solutions`;

CREATE TABLE `shl_solutions` (
  `id` int(11) NOT NULL auto_increment,
  `channelId` int(11) NOT NULL default '0',
  `title` varchar(60) NOT NULL default '',
...
/*Data for the table `shl_solutions` */

/*Table structure for table `shl_solutions_content` */

DROP TABLE IF EXISTS `shl_solutions_content`;

CREATE TABLE `shl_solutions_content` (
...
/*Data for the table `shl_solutions_content` */

/*Table structure for table `shl_user` */

DROP TABLE IF EXISTS `shl_user`;
...
/*Data for the table `shl_user` */

insert  into `shl_user`(`id`,`nickname`,`email`,`username`,`pwd`,`role`,`right`,`dtTime`,`auditing`,`ip`,`detail1`,`detail2`,`detail3`,`detail4`,`detail5`) values (1,'管理员','admin@localhost','admin','d033e22ae348aeb5660fc2140aec35850c4da997',9,'\'0\'','2008-11-19 01:34:26',1,'127.0.0.1','','','','',''),(2,'管理员','admin@localhost','admin','d033e22ae348aeb5660fc2140aec35850c4da997',9,'\'0\'','2013-02-20 07:12:18',1,'127.0.0.1','','','','','');
